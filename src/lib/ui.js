...
export function showInfo(message, ...actions) {
  return vscode.window.showInformationMessage(`${EXTENSION_NAME}: ${message}`, ...actions);
}
...
export function showWarning(message, ...actions) {
  return vscode.window.showWarningMessage(`${EXTENSION_NAME}: ${message}`, ...actions);
}
...
export function showError(message, ...actions) {
  ...
  return vscode.window.showErrorMessage(`${EXTENSION_NAME}: ${message}`, ...actions);
}
